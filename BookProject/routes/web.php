...
Route::post('/account_change', 'App\Http\Controllers\AccountchangeController@change_post')->name("account_manage_change.post");
...
Route::get('/mypage', 'App\Http\Controllers\GetbookController@showp');